...
const (
	Calculator_Calculate_FullMethodName = "/final.Calculator/Calculate"
)
...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Result, error) {
...
type CalculatorServer interface {
	Calculate(context.Context, *Task) (*Result, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *Task) (*Result, error) {
...
func _Calculator_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calculate(ctx, req.(*Task))
	}
